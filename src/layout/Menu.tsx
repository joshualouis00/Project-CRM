...
import { useTranslate, DashboardMenuItem, MenuItemLink, type MenuProps, useSidebarState } from "react-admin";
...
const Menu = ({ dense = false }: MenuProps) => {
  ...
  return (
    ...
    >
      ...
      <SubMenu handleToggle={() => handleToggle("menuSettings")} isOpen={state.menuSettings} name="pos.menu.settings" icon={<security.icon />} dense={dense}>
        <MenuItemLink
          to="/security"
          state={{ _scrollToTop: true }}
          primaryText={translate(`resources.security.name`, {
            smart_count: 2,
          })}
