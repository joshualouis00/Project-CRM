...
const indonesianMessages: TranslationMessages = {
  ...
  resources: {
    customers: {
      ...
      notifications: {
        created: "Pelanggan dibuat |||| %{smart_count} Pelanggan dibuat",
        updated: "Pelanggan diperbarui |||| %{smart_count} Pelanggan diperbarui",
        deleted: "Pelanggan dihapus |||| %{smart_count} Pelanggan dihapus",
      },
    },
    orders: {
    ...
    categories: {
      ...
      notifications: {
        created: "Kategori berhasil dibuat |||| %{smart_count} kategori berhasil dibuat",
        updated: "Kategori berhasil diperbarui |||| %{smart_count} kategori berhasil diperbarui",
        deleted: "Kategori berhasil dihapus |||| %{smart_count} kategori berhasil dihapus",
      },
    },
    security: {
      name: "Keamanan |||| Keamanan",
      fields: {
        products: "Produk",
      },
      notifications: {
        created: "Keamanan berhasil dibuat |||| %{smart_count} Keamanan berhasil dibuat",
        updated: "Keamanan berhasil diperbarui |||| %{smart_count} Keamanan berhasil diperbarui",
        deleted: "Keamanan berhasil dihapus |||| %{smart_count} Keamanan berhasil dihapus",
      },
    },
    reviews: {
      name: "Ulasan |||| Ulasan",
